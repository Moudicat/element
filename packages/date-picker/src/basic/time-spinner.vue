...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'mdc-element-ui/src/utils/date-util';
  import ElScrollbar from 'mdc-element-ui/packages/scrollbar';
  import RepeatClick from 'mdc-element-ui/src/directives/repeat-click';
