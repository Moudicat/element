...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'mdc-element-ui/src/utils/date-util';
  import { hasClass } from 'mdc-element-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'mdc-element-ui/src/utils/util';
